...
from openkb.config import (
    ...
    resolve_concurrency,
    set_extra_headers,
    install_global_litellm_headers,
...
def _setup_llm_key(kb_dir: Path | None = None) -> None:
    ...
    # Stomp the configured headers (User-Agent override, provider auth, ...)
    # onto EVERY litellm call in the process, so direct LiteLLM users like
    # PageIndex during long-document indexing are also covered.
